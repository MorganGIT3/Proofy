      ...
      <div className={cn("flex flex-col items-center justify-center", className)}>
        ...
        >
          ...
          <CardContent className="grid gap-4">
            ...
            <Button onClick={primaryAction.onClick} className="w-full transition-transform hover:scale-[1.03]" disabled={primaryAction.label.includes("Connexion...")}>
              {primaryAction.icon}
              {primaryAction.label}
            </Button>
        ...
        {/* Footer */}
        {footerContent && (
          <div className="mt-6 w-full max-w-sm px-8 text-center text-sm text-gray-400 animate-in fade-in-0 zoom-in-95 slide-in-from-bottom-4 duration-500 [animation-delay:200ms]">
            {footerContent}
          </div>
        )}
      </div>
